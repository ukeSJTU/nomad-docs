...
这确保了我们能首先集中精力交付产品的核心价值。完整内容请看[项目范围](/docss/introduction/scope)
...
更多例子请看每一个功能需求的`4. 验收标准(Acceptance Criteria)`部分，例如[这里](/docs/functional-requirements/user-module#4-验收标准-acceptance-criteria)
...
**部署链接**：[https://nomad.ukehome.top](https://nomad.ukehome.top)
...
<Cards>
  <Card title="引言部分" description="项目目标 | 项目范围 | 目标用户 | 术语定义" href="/docs/introduction
  " />
  <Card title="总体描述" description="产品愿景 | 用户特征 | 业务流程图 | 假设与约束" href="/docs/overall-description" />
  <Card title="功能需求" description="用户模块 | 机票模块 | 订单模块 | 支付模块" href="/docs/functional-requirements" />
  <Card title="非功能需求" description="性能 | 安全 | 兼容性 | 可用性" href="/docs/non-functional-requirements" />
  <Card title="技术设计" description="架构设计 | 数据库设计 | 开发规范 | Git工作流" href="/docs/01-architecture" />
</Cards>
