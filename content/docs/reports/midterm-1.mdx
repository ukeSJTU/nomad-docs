...
这是我们单独配置的一个Trae智能体，添加了`GitHub MCP`。通过明确的提示词，让智能体创建清晰的Issue内容：
...
我们小组目前已经实现了以下功能，欢迎体验点击下面的链接体验。

- 手机号注册/登录
- 邮箱注册/登录
- 常用旅客信息管理

部署链接：https://nomad.vercel.app

<Callout title="请注意" type="warning">
    短信发送和邮件发送都是付费的，因此中期汇报暂时没有启用，请直接用GitHub OAuth登录体验。
</Callout>

源代码链接：https://github.com/ukeSJTU/nomad

本文档代码链接：https://github.com/ukeSJTU/nomad-docs
